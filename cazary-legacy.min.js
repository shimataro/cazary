...
Redo:"\u3084\u308a\u76f4\u3057",Underline:"\u4e0b\u7dda",Size:"\u30b5\u30a4\u30ba"}},B=function(){var b;try{var g=w.navigator;b=g.browserLanguage||g.language||g.userLanguage}catch(B){b=d}g=a[b];if(g!==d)return g;b=b.split("-")[0];g=a[b];return g!==d?g:{}}();return function(a){return B[a]===d?a:B[a]}}(),N=function(){var a=/^[\w\!\#\$\%\&\'\*\+\-\/\=\?\^\`\{\|\}\~](\.?[\w\!\#\$\%\&\'\*\+\-\/\=\?\^\`\{\|\}\~])*@([\w\-]+\.)+(\w+)$/;return function(d){return 256<d.length||64<d.indexOf("@")||null==d.match(a)?
!1:!0}}(),F=function(){var a=/^https?:\/\//;return function(d){return null==d.match(a)?!1:!0}}(),R=function(){return function(a,n,b){function g(a,d){"backcolor"==a&&x("hilitecolor")&&(a="hilitecolor");y();e.execCommand(a,!1,d)}function x(a){try{return e.queryCommandEnabled(a)}catch(d){return!1}}function w(a){0===a.length&&(e.body.innerHTML="\u200b");e.body.innerHTML=a}function l(){if(p.getSelection){var a=p.getSelection();return null===a||0===a.rangeCount?"":a.getRangeAt(0).toString()}return e.selection.createRange().text}
function y(){p.focus();null!==H&&H.select()}var p=a.contentWindow,e=p.document;a.contentDocument&&(e=a.contentDocument);var H=null;this.STATUS_NORMAL=0;this.STATUS_ACTIVE=1;this.STATUS_DISABLED=2;this.COMMAND_FONTNAME="fontname";this.COMMAND_FONTSIZE="fontsize";this.COMMAND_BOLD="bold";this.COMMAND_ITALIC="italic";this.COMMAND_UNDERLINE="underline";this.COMMAND_STRIKETHROUGH="strikethrough";this.COMMAND_REMOVEFORMAT="removeformat";this.COMMAND_FORECOLOR="forecolor";this.COMMAND_BACKCOLOR="backcolor";
...
d)switch(h.verticalAlign.toLowerCase()){case "super":a.superscript=1;break;case "sub":a.subscript=1}if(h.textAlign!==d)switch(h.textAlign.toLowerCase()){case "left":a.justifyleft=1;break;case "center":a.justifycenter=1;break;case "right":a.justifyright=1;break;case "justify":a.justifyfull=1}}k=k.parentNode}e.selection&&(H=e.selection.createRange());return a};this.execCommand=g;this.canExecCommand=x;this.value=function(a){if(a===d)return a=e.body.innerHTML,a=a.replace(/(<\/?)p\b/gi,"$1div").replace(/(<\/?)em\b/gi,
...
"source"],FULL:"fontname fontsize;bold italic underline strikethrough removeformat | forecolor backcolor | superscript subscript;justifyleft justifycenter justifyright justifyfull | indent outdent | insertorderedlist insertunorderedlist;inserthorizontalrule insertimage createlink unlink;undo redo;source".split(";")};a(function(a){a(J).bind("click",function(){b()}).bind("keydown",function(a){27===a.keyCode&&b()})});return function(l){l=a.extend({mode:"rte",style:"body{margin:0px;padding:8px;}p{margin:0px;padding:0px;}",
...
"#666666 #990000 #cc6600 #cc9933 #999900 #009900 #339999 #3333ff #6600cc #993399".split(" "),"#333333 #660000 #993300 #996633 #666600 #006600 #336666 #000099 #333399 #663366".split(" "),"#000000 #330000 #663300 #663333 #333300 #003300 #003333 #000066 #330099 #330033".split(" ")],commands:"STANDARD"},l);return this.each(function(){function g(a,u){b();c.execCommand(a,u);z()}function p(){var a=r.val();c.value(a);K();r.hide();G.css("display","");L.removeClass("cazary-disabled");C.removeClass("cazary-active");
z()}function e(){var a=c.value();r.val(a);G.hide();r.css("display","");L.addClass("cazary-disabled");C.addClass("cazary-active")}function v(t,u,D){var f=a(".cazary-panel");if(0<f.length){var m=f.data("id"),f=f.data("command");b();if(f===t&&m===M){I();return}}m=!1;switch(t){case c.COMMAND_FONTNAME:f=O(t,u.fontnames);m=!0;break;case c.COMMAND_FONTSIZE:f=k(t);m=!0;break;case c.COMMAND_FORECOLOR:case c.COMMAND_BACKCOLOR:f=h(t,u.colors);m=!0;break;case c.COMMAND_INSERTIMAGE:f=Q(t);break;case c.COMMAND_CREATELINK:f=
P(t);break;default:return null}m&&f.find("li").bind("click",function(){var f=a(this).data("param");g(t,f)});u=D.addClass("cazary-active").offset();u.top+=D.outerHeight();f.addClass("cazary-panel").addClass("cazary-panel-"+t).data("id",M).data("command",t).css({left:u.left+"px",top:u.top+"px"}).bind("click",function(){return!1}).appendTo(a(J.body)).find(":text:first").trigger("focus");return f}function O(c,b){var D=a("<ul />").addClass("cazary-widget-select");a.each(b,function(){var f=this.toString(),
f=a("<li />").attr({unselectable:"on",title:f}).css({"font-family":f}).data("param",f).text(f);D.append(f)});return a("<div>").append(D)}function k(b){var c=a("<ul />").addClass("cazary-widget-select");a.each(x,function(b,f){f=n(f);var m=a("<li />").attr({unselectable:"on",title:f}).data("param",b),d=a("<font />").attr({size:b}).text(f);c.append(m.append(d))});return a("<div>").append(c)}function h(b,c){var d=a("<div>");a.each(c,function(){var f=a("<ul />").addClass("cazary-widget-select-color");
a.each(this,function(){var b=this.toString(),b=a("<li />").attr({unselectable:"on",title:b}).css({"background-color":b}).data("param",b).text(b);f.append(b)});d.append(f)});return d}function Q(b){function c(){var a=d.find(".cazary-widget-insertimage-url"),m=a.val();if(!F(m))return a.trigger("focus"),!1;g(b,m);return!1}var d=a("<div>").append(a("<form />").attr("action","#").append(a("<div />").append(a("<fieldset />").append(a("<legend />").text(n("Input image URL"))).append(a('<input type="text" />').addClass("cazary-widget-insertimage-url").attr({required:"required",
placeholder:n("http://example.com/path/to/image.jpg")}))).append(a('<input type="submit" />').addClass("cazary-widget-submit").val(n("Insert")))).append(a("<fieldset />").addClass("cazary-widget-preview").append(a("<legend />").text(n("Preview"))).append(a("<img />").addClass("cazary-widget-preview-insertimage"))));d.find("form").bind("submit",c);d.find(".cazary-widget-submit").bind("click",c);d.find(".cazary-widget-insertimage-url").bind("keydown paste",function(){var b=a(this);w.setTimeout(function(){var a=
b.val(),c=b.data("url_old");a!==c&&(b.data("url_old",a),c=d.find(".cazary-widget-preview"),F(a)?(c.show(),d.find(".cazary-widget-preview-insertimage").attr("src",a)):c.hide())},10)});return d}function P(b){function c(){var a=d.find(".cazary-widget-createlink-url"),m=a.val();if(N(m))m="mailto:"+m;else if(!F(m))return a.trigger("focus"),!1;g(b,m);return!1}var d=a("<div>").append(a("<form />").attr("action","#").append(a("<div />").append(a("<fieldset />").append(a("<legend />").text(n("Input link URL or E-mail address"))).append(a('<input type="text" />').addClass("cazary-widget-createlink-url").attr({required:"required",
placeholder:n("http://example.com/, someone@example.com")}))).append(a('<input type="button" />').addClass("cazary-widget-submit").val(n("Insert")))).append(a("<fieldset />").addClass("cazary-widget-preview").append(a("<legend />").text(n("Preview"))).append(a("<iframe />").addClass("cazary-widget-preview-createlink"))));d.find("form").bind("submit",c);d.find(".cazary-widget-submit").bind("click",c);d.find(".cazary-widget-createlink-url").bind("keydown paste",function(){var b=a(this);w.setTimeout(function(){var a=
b.val(),c=b.data("url_old");a!==c&&(b.data("url_old",a),c=d.find(".cazary-widget-preview"),F(a)?(c.show(),d.find(".cazary-widget-preview-createlink").attr("src",a)):c.hide())},10)});return d}function z(){var a=c.getCurrentStatus(),b;for(b in a){var d=a[b],f=q.find(".cazary-command-"+b);if(b===c.COMMAND_FONTNAME){var e=d;null===e&&(d="",e=f.attr("title"));f.css({"font-family":d}).text(e)}else b===c.COMMAND_FONTSIZE?(e=d,e=null===e?f.attr("title"):n(x[e]),f.text(e)):b===c.COMMAND_FORECOLOR||b===c.COMMAND_BACKCOLOR?
(q.find(".cazary-command-"+b),null===d?q.find(".cazary-command-"+b).css("background-color",""):q.find(".cazary-command-"+b).css("background-color",d)):(d===c.STATUS_ACTIVE?f.addClass("cazary-active"):f.removeClass("cazary-active"),d===c.STATUS_DISABLED?f.addClass("cazary-disabled"):f.removeClass("cazary-disabled"))}}function I(){C.hasClass("cazary-active")?r.trigger("focus"):c.setFocus()}function K(){var b=a(c.contentDocument.body);0===b.text().length?b.addClass("empty"):b.removeClass("empty")}var M=
parseInt(1E4*Math.random()),r=a(this),q=a('<div class="cazary"><iframe class="cazary-edit" src="javascript:"></iframe></div>').css({width:r.width()});q.prepend(B(l.commands));var G=q.find(".cazary-edit").css({height:r.height()}),C=q.find("ul.cazary-commands-list li.cazary-command-source"),L=q.find("ul.cazary-commands-list li:not(.cazary-command-source)");r.hide().before(q).insertAfter(G).addClass("cazary-source");var E=l.style,A=r.attr("placeholder");A!==d&&(A=A.replace("'","\\'"),E+="body.empty:before{position:fixed;color:#888;content:'"+
A+"';}");var c=new R(G.get(0),r.val(),E),E=[c.COMMAND_BOLD,c.COMMAND_ITALIC,c.COMMAND_UNDERLINE,c.COMMAND_STRIKETHROUGH,c.COMMAND_REMOVEFORMAT,c.COMMAND_SUPERSCRIPT,c.COMMAND_SUBSCRIPT,c.COMMAND_JUSTIFYLEFT,c.COMMAND_JUSTIFYCENTER,c.COMMAND_JUSTIFYRIGHT,c.COMMAND_JUSTIFYFULL,c.COMMAND_INDENT,c.COMMAND_OUTDENT,c.COMMAND_ORDEREDLIST,c.COMMAND_UNORDEREDLIST,c.COMMAND_INSERTHORIZONTALRULE,c.COMMAND_UNLINK,c.COMMAND_UNDO,c.COMMAND_REDO],A=[c.COMMAND_FONTNAME,c.COMMAND_FONTSIZE,c.COMMAND_FORECOLOR,c.COMMAND_BACKCOLOR,
c.COMMAND_INSERTIMAGE,c.COMMAND_CREATELINK];"html"==l.mode?e():p();a(c.contentDocument).bind("select",function(){z()}).bind("mouseup",function(){b();z()}).bind("keydown",function(a){27===a.keyCode&&b()}).bind("keyup paste",function(){w.setTimeout(function(){z();K()},10)});a(c.contentWindow).bind("focus",function(){b();z()}).bind("blur",function(){r.val(c.value())});q.find("ul.cazary-commands-list li").bind("click",function(b){a(this).hasClass("cazary-disabled")&&(b.stopImmediatePropagation(),I())});
C.bind("click",function(){C.hasClass("cazary-active")?p():e();I()});a.each(E,function(){var a=this.toLowerCase();q.find(".cazary-command-"+a).bind("click",function(){g(a)})});a.each(A,function(){var b=this.toLowerCase();q.find(".cazary-command-"+b).bind("click",function(){var c=a(this);v(b,l,c);return!1})})})}}(v)})})(jQuery,window);